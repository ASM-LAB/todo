...
CREATE TABLE IF NOT EXISTS public.tareas (
    ...
    estado TEXT NOT NULL DEFAULT 'pendiente' CHECK (estado IN ('pendiente', 'en curso', 'rechazada', 'resuelta', 'guardado')),
...
-- ALTER TABLE public.tareas ADD CONSTRAINT tareas_estado_check CHECK (estado IN ('pendiente', 'en curso', 'rechazada', 'resuelta', 'guardado'));
